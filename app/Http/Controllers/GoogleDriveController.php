...
class GoogleDriveController extends Controller
{
    ...
    function __construct(){
        ...
        $this->gClient->setClientId('311333808553-1ifh8ccqvj7i967nqj6qjd7eq18p2fr3.apps.googleusercontent.com');
        $this->gClient->setClientSecret('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');
        $this->gClient->setRedirectUri('YOUR REDIRECT URL');
        $this->gClient->setDeveloperKey('AIzaSyDQCCSm7cXBiAwT4mk907Qb_nDNkBZE6Yg');
